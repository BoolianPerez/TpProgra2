...
import BusquedaProductos.ArbolAVL_Stock;
...
public class SistemaLogistico {
        ...
        while (!volver) {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    Almacen.Pasillo pasilloEncontrado = almacen.buscarPasilloPorId(idBusPasillo);
        ...
        while (!volver) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    MovimientoLotes.Movimiento tope = movimientos.verTope();
                    if (tope != null) {
    ...
    private void crearYAgregarMovimiento() {
        ...
        if (prodEncontrado != null) {
            MovimientoLotes.Ubicacion ubicacion = new MovimientoLotes.Ubicacion(p, estante, nivel);
            MovimientoLotes.Lote lote = new MovimientoLotes.Lote(
